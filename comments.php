...
<p id="purple_pragraph">Thanks for reading! I love hearing your thoughts and comments and really appreciate all your support. XOXO</p><br />
...
<?php else : ?>
                                                        ...
                                                        <p id="comment-notes"><?php _e('Your email is <em>never</em> published nor shared.', 'your-theme') ?> <?php if ($req) _e('Required fields are marked <span class="required">*</span>', 'your-theme') ?></p><br />
